...
class BreakfastMenusActivity : AppCompatActivity() {
    ...
    private fun getMenuData() {
        ...
        dbREF.addValueEventListener(object: ValueEventListener {
                ...
                if (snapshot.exists()){
                    ...
                    adapter.setOnItemClickListener(object: MyAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            val intent = Intent(this@BreakfastMenusActivity, ProvidersActivity::class.java)
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@BreakfastMenusActivity, error.toString(), Toast.LENGTH_SHORT).show()
            }
        })
